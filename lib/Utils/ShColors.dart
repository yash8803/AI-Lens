...
const sh_green = Color(0xFF5C8637);
const sh_green_dark = Color(0xFF004D00);
const sh_bg_green=Color(0xFFDCEDC8);
const sh_bg_green1=Color(0xFFE4F1D4);
const sh_appbar_bgcolor= Color(0xFF800000);
...
const red2 = Color(0XFFEF9A9A);
const red3 = Color(0XFFEF9A9A);

//bluegrey shades
const sh_appbar = Color(0xFF78909C);
const bluegrey1 = Color(0XFFCFD8DC);
const sh_title_font = Color(0XFF37474F);
const sh_btn = Color(0XFF263238);
const bluegrey5 = Color(0XFF607D8B);
const sh_card = Color(0XFFECEFF1);

const brown = Color(0XFFA887F);
const brown2 = Color(0XFF8D6E63);

const brown1 = Color(0XFF795548);
